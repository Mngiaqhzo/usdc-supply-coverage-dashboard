# USDC Circulating Supply & Reserve Coverage Dashboard
...
1. USDC circulating supply trend
2. Daily minted amount
3. Daily burned amount
4. Daily net supply change
5. Estimated reserve surplus
6. Estimated reserve coverage ratio
7. Latest dashboard KPI summary
